...
#define AAAA st_replace_right(del, least) 
#define BBBB st_update(root, least) 
#define CCCC st_replace_left(del, most)
#define DDDD st_update(root, most)
#define EEEE st_update(root, parent)
